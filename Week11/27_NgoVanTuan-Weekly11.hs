...
listFiles = do
  ...
  putStrLn ("Number of entries in the current directory: " ++ show fileCount)
...
createMsg = do
  ...
  readMessage <- readFile "msg.txt"
  putStrLn ("The message from the file is: " ++ readMessage)
...
benchmark :: IO ()
benchmark = do
  putStrLn "Nhap gia tri gioi han: "
  value <- read <$> getLine
  let listPrime = [(primes1, "primes1"), (primes2, "primes2"), (primes3, "primes3")]
