...
createStringFactorial :: Integer -> String
createStringFactorial n | n <= 1 = "1"
createStringFactorial n =  createStringFactorial (n-1) ++ "*" ++ show n

createFactorial :: Integer -> String
createFactorial n | n <= 1 = "1"
createFactorial n = createStringFactorial n ++ "=" ++ (show $ factorial' n)
...
calCost :: [(String, Double)] -> [(String, Double)] -> Double
calCost [] _ = 0
calCost _ [] = 0
calCost (x:xs) (y:ys) = snd x * snd y + deliveryCost + calCost xs ys