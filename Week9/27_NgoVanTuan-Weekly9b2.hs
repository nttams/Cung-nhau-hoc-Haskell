...
moveForest (staminaLeft, Trail stamina forest1 forest2 forest3) move =
    case move of
        GoLeft -> (staminaLeft - stamina, forest1)
        GoRight -> (staminaLeft - stamina, forest3)
        GoForward -> (staminaLeft - stamina, forest2)
